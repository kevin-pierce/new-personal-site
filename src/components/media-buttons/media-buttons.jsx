...
const MediaButtons = () => {
    return (
        <div className="media-buttons-wrapper">
            <a class="styled-icon" href="https://github.com/kevin-pierce">
            ...
            <a class="styled-icon" href="https://www.linkedin.com/in/kwpierce/">
            ...
            <a class="styled-icon" href="mailto:k3pierce@uwaterloo.ca">
