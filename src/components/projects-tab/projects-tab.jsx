                ...
                <div className="flip-card">
                    <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back">
                            <Card>
                                <Card.Header>PATHCA</Card.Header>
                                <Card.Body className="card-body">
                                    <Card.Text>
                                        A data-aggregation and educational <strong>pathology</strong> tool that pushes for the digitization of the field.
                                        Abstract and poster presentation submitted to 2022 Schulich Pathology Research Day, under Digital Pathology group. <a href="https://www.schulich.uwo.ca/pathol/research/palm_research_day/img/2022/3B%20Digital%20Pathology.pdf">Available for viewing here.</a>
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                        </div>
