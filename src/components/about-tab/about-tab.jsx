...
const AboutTab = () => {
    return (
        <div className="about-tab-wrapper">
            <h2>Oh, hey there!</h2>
            <div>
                I'm an incoming-2B Software Engineering student at the University of Waterloo, with an <br/>
                    interest in full stack development. 
                    <br/><br/>
                    Currently, I'm working at <a href="https://www.wish.com/">Wish</a> as a Software Engineering Intern on the Marketplace Orders Team. 
                    <br/>
